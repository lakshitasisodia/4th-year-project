export const validateStressLevelInput = (data) => {
  ...
  // Exact ranges from backend config.py Config.FIELD_RANGES, verified against
  // the complete StressLevelDataset.csv (1100 rows). 12 of these were wrong
  // before (e.g. sleep_quality was 0-10; real data never exceeds 5).
  const ranges = {
    anxiety_level: [0, 21],
    self_esteem: [0, 30],
