...
export const STRESS_LEVEL_FIELDS = [
  ...
  { name: 'sleep_quality', label: 'Sleep Quality', min: 0, max: 10, type: 'number' },
  { name: 'breathing_problem', label: 'Breathing Problem', min: 0, max: 10, type: 'number' },
  { name: 'noise_level', label: 'Noise Level', min: 0, max: 5, type: 'number' },
  { name: 'living_conditions', label: 'Living Conditions', min: 0, max: 10, type: 'number' },
  { name: 'safety', label: 'Safety', min: 0, max: 10, type: 'number' },
  { name: 'basic_needs', label: 'Basic Needs', min: 0, max: 10, type: 'number' },
  { name: 'academic_performance', label: 'Academic Performance', min: 0, max: 5, type: 'number' },
  { name: 'study_load', label: 'Study Load', min: 0, max: 10, type: 'number' },
  { name: 'teacher_student_relationship', label: 'Teacher-Student Relationship', min: 0, max: 10, type: 'number' },
  { name: 'future_career_concerns', label: 'Future Career Concerns', min: 0, max: 10, type: 'number' },
  { name: 'social_support', label: 'Social Support', min: 0, max: 12, type: 'number' },
  { name: 'peer_pressure', label: 'Peer Pressure', min: 0, max: 10, type: 'number' },
  { name: 'extracurricular_activities', label: 'Extracurricular Activities', min: 0, max: 10, type: 'number' },
  { name: 'bullying', label: 'Bullying', min: 0, max: 10, type: 'number' }
]
